...
public:
    ...
    void fireStatusEvent(const CommonAPI::ByteBuffer &_protoStatus);
...
void E01HelloWorldSomeIPStubAdapterInternal<_Stub, _Stubs...>::fireStatusEvent(const CommonAPI::ByteBuffer &_protoStatus) {
    CommonAPI::Deployable< CommonAPI::ByteBuffer, CommonAPI::SomeIP::ByteBufferDeployment> deployed_protoStatus(_protoStatus, static_cast< CommonAPI::SomeIP::ByteBufferDeployment* >(nullptr));
