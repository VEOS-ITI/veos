...
class E01HelloWorldStubAdapter
 ...
 public:
    ...
    */
    virtual void fireStatusEvent(const CommonAPI::ByteBuffer &_protoStatus) = 0;
...
public:
    ...
    virtual void fireStatusEvent(const CommonAPI::ByteBuffer &_protoStatus) {
        auto stubAdapter = CommonAPI::Stub<E01HelloWorldStubAdapter, E01HelloWorldStubRemoteEvent>::stubAdapter_.lock();
        if (stubAdapter)
            stubAdapter->fireStatusEvent(_protoStatus);
    }
